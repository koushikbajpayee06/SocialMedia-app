    ...
    <div className='min-h-screen relative bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        <div  className='inline-flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-sm'>
          {
            dataArray.map((tab)=>(
              <button onMouseOver={()=>setCurrentTab(tab.label)} key={tab.label} className={`cursor-pointer flex item-center px-3 py-1 text-sm rounded-md transition-colors
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    ...
                    }
                    {
                      currentTab === "Connections" && (
                        <button onClick={()=>navigate(`/messages/${user._id}`)} className='w-full p-2 text-sm rounded bg-gradient-to-r from-indigo-500 to-purple-600
                          hover:from-indigo-600 hover:to-purple-700 active:scale-95
                          transition text-white cursor-pointer'>

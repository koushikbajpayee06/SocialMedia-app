import { ArrowLeft, Sparkle, TextIcon, Upload, Users } from 'lucide-react'
        ...
        <div className='w-full max-w-md'>
            ...
            <div className='rounded-lg h-96 flex items-center justify-center relative' style={{backgroundColor:background}}>
                {mode ==='text' && (
                    ...
                    placeholder="What's on your mind" name="" id="" onChange={(e)=>setText(e.target.value)} value={text}/>
                )}
                {
            ...
            <div className='flex mt-4 gap-2 '>
                {bgColors.map((color)=>(
                    <button key={color} className='w-6 h-6 rounded-full cursor-pointer' style={{backgroundColor:color}} 
            ...
            <div className='flex gap-2 mt-4'>
                ...
                <label className={`flex-1 flex items-center justify-center gap-2 p-2 rounded cursor-pointer
                    ...
                    type="file" name="" id="" accept='image/*,video/*' className='hidden'/>

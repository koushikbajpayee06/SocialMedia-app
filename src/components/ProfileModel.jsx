            ...
            <form action="" className='space-y-4' onSubmit={handleSaveProfile}>
                ...
                <div className='flex flex-col items-start gap-3'>
                    <label htmlFor='cover_photo' className='block text-sm font-medium text-gray-700 mb-1'>
                        Cover Photo
                        <input type="file" hidden accept='image/*' id='cover_photo' className='w-full p-3 border border-gray-200 rounded-lg'
                ...
                <div>
                    ...
                    onChange={(e)=>setEditForm({...editForm, full_name: e.target.value})} value={editForm.full_name} name="" id="" />
                </div>
                ...
                <div>
                    ...
                    onChange={(e)=>setEditForm({...editForm, username: e.target.value})} value={editForm.username} name="" id="" />
                </div>
                ...
                <div>
                    ...
                    <textarea rows={3}  className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter a sort bio' 
                ...
                <div>
                   ...
                   <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your location' 
                    onChange={(e)=>setEditForm({...editForm, location: e.target.value})} value={editForm.location} name="" id="" />
                </div>
                ...
                <div className='flex justify-end space-x-3 pt-6'>
                    ...
                    <button type='submit' className='px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600
                     hover:to-purple-700 transition cursor-pointer'>Save Cahnges</button>
                </div>
            </form>
        </div>
      </div>
